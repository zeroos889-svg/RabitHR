...
const specializations = [
  {
    ...
    descriptionAr:
      "إدارة علاقات العمل والنزاعات العمالية وفقاً لنظام العمل السعودي",
    descriptionEn:
      "Managing labor relations and disputes according to Saudi Labor Law",
    icon: "Users",
    color: "#3B82F6",
    orderIndex: 1,
  },
  ...
  },
  {
    ...
    descriptionEn:
      "Designing and implementing training and professional development programs",
    icon: "GraduationCap",
    color: "#F59E0B",
    orderIndex: 4,
  },
...
const consultationTypes = [
  {
    ...
    relatedSpecializations: JSON.stringify([
      "labor-relations",
      "legal-compliance",
    ]),
    icon: "AlertTriangle",
