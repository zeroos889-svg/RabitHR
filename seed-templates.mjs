...
const templateData = [
  // خطابات التوظيف
  {
    ...
    category: "employment",
    aiPrompt:
      "اكتب خطاب عرض عمل رسمي يتضمن المسمى الوظيفي، الراتب، المزايا، تاريخ البدء، وشروط العمل.",
  },
  {
    ...
    category: "employment",
    aiPrompt:
      "اكتب عقد عمل رسمي متوافق مع نظام العمل السعودي يتضمن جميع البنود القانونية المطلوبة.",
  },
  {
  ...
  // الشهادات
  {
    ...
    aiPrompt:
      "اكتب شهادة راتب رسمية للبنوك تتضمن المسمى الوظيفي والراتب الشهري.",
  },
  {
