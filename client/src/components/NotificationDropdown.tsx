          ...
          <div className="py-1">
            {notifications.map((notification) => (
              <div key={notification.id}>
                ...
                >
                  <div className={`h-8 w-8 rounded-full ${getTypeColor(notification.type)} flex items-center justify-center flex-shrink-0`}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      {!notification.read && (
                        <Badge variant="secondary" className="h-4 px-1.5 text-xs bg-blue-600 text-white">
                          جديد
                        </Badge>
                      )}
                    </div>
