        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              مساعدك الذكي في إدارة الموارد البشرية. نوفر أدوات متقدمة بتقنية الذكاء الاصطناعي 
              لتسهيل عمل HR وتوفير الوقت والجهد، مع التوافق الكامل مع نظام العمل السعودي.
            </p>
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                <Button size="icon" className="bg-gradient-to-r from-blue-600 to-purple-600 flex-shrink-0">
          ...
          <div>
            ...
            <ul className="space-y-3 text-muted-foreground">
              ...
              <li>
                <Link href="/tools/leave-calculator" className="hover:text-primary transition-colors">
                  حاسبة الإجازات
                </Link>
              </li>
              <li>
                <Link href="/tools/letter-generator" className="hover:text-primary transition-colors">
                  مولد الخطابات
                </Link>
              </li>
              <li>
                <Link href="/verify-decision" className="hover:text-primary transition-colors">
                  التحقق القانوني
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-4 text-muted-foreground">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@rbithr.com" className="hover:text-primary transition-colors">
                    info@rbithr.com
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:0570700355" className="hover:text-primary transition-colors">
                    0570700355
                  </a>
                </div>
              </li>
