...
const tools = [
  ...
  },
  {
    ...
    href: "#",
    comingSoon: true,
    features: ["حساب التأمينات الاجتماعية", "خصم GOSI", "البدلات والحوافز"],
  },
  {
    id: "attendance",
    ...
    href: "#",
    comingSoon: true,
    features: ["حساب ساعات العمل", "خصم الغياب والتأخير", "تقارير الحضور"],
  },
  {
    id: "performance",
  ...
  },
  {
    ...
    href: "#",
    comingSoon: true,
    features: ["تكلفة الإعلان والتوظيف", "تكلفة التدريب", "التكلفة الإجمالية"],
  },
  {
    id: "contract",
    ...
    href: "#",
    comingSoon: true,
    features: ["عقود متوافقة مع النظام", "قوالب جاهزة", "تخصيص كامل"],
  },
];
        ...
        <div className="container text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              مجموعة شاملة من الأدوات والحاسبات المدعومة بالذكاء الاصطناعي
              لإدارة الموارد البشرية بكفاءة
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tools.map(tool => (
              ...
              >
                ...
                <div
                  className={`absolute top-0 right-0 left-0 h-2 bg-gradient-to-r ${tool.color}`}
                />

                <CardHeader className="pb-4">
                  <div
                    className={`w-14 h-14 rounded-xl ${tool.bgColor} flex items-center justify-center mb-4`}
                  >
                ...
                <CardContent>
                  <ul className="space-y-2 mb-6">
                    {tool.features.map((feature, index) => (
                      ...
                      >
                        <div
                          className={`h-1.5 w-1.5 rounded-full ${tool.bgColor}`}
                        ></div>
