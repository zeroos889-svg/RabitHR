...
export default function ConsultingBookingNew() {
  ...
  const handleSubmit = async () => {
    ...
    if (!selectedTypeId || !selectedConsultantId || !selectedDate || !selectedTime) {
      ...
      <div className="container max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between mt-2 text-sm">
            <span className={step >= 1 ? 'text-purple-600 font-medium' : 'text-gray-500'}>نوع الاستشارة</span>
            <span className={step >= 2 ? 'text-purple-600 font-medium' : 'text-gray-500'}>المستشار</span>
            <span className={step >= 3 ? 'text-purple-600 font-medium' : 'text-gray-500'}>الموعد والمتطلبات</span>
            <span className={step >= 4 ? 'text-purple-600 font-medium' : 'text-gray-500'}>التأكيد</span>
          </div>
        </div>
          ...
          {step === 1 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">حدد نوع الاستشارة التي تحتاجها</p>
              </div>
                ...
                {typesData?.consultationTypes?.map((type: any) => (
                  <Card
                    ...
                    className={`p-4 cursor-pointer transition-all hover:shadow-lg ${
                      selectedTypeId === type.id ? 'border-2 border-purple-600 bg-purple-50' : ''
                    }`}
                ...
                <div className="space-y-4">
                  {consultantsData?.consultants?.map((consultant: any) => (
                    <Card
                      key={consultant.id}
                      className={`p-4 cursor-pointer transition-all hover:shadow-lg ${
                        selectedConsultantId === consultant.id ? 'border-2 border-purple-600 bg-purple-50' : ''
                      }`}
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <div className="flex justify-between items-start">
                            <div>
                              <h3 className="font-bold">{consultant.fullNameAr}</h3>
                          ...
                          <p className="text-sm mt-2 line-clamp-2">{consultant.bioAr}</p>
                        </div>
                      </div>
                    </Card>
                  ))}
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">حدد الموعد وأرفق المستندات المطلوبة</p>
              </div>
                    ...
                    <div key={index}>
                      ...
                      {field.type === 'textarea' ? (
                        <Textarea
                          ...
                          onChange={(e) => setRequiredInfo(prev => ({
                            ...prev,
                        ...
                        <Select
                          value={requiredInfo[field.nameAr] || ''}
                          onValueChange={(value) => setRequiredInfo(prev => ({
                            ...prev,
                            [field.nameAr]: value
                          }))}
                        >
                      ...
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          <Label className="text-base">
                            {doc.nameAr} {doc.required && <span className="text-red-500">*</span>}
                          </Label>
          ...
          {step === 4 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">راجع تفاصيل حجزك قبل التأكيد</p>
              </div>
              ...
              <div className="space-y-4">
                <Card className="p-4 bg-purple-50">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{selectedType?.nameAr}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">المستشار:</span>
                      <span className="font-medium">{selectedConsultant?.fullNameAr}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex gap-3">
                  ...
                  <div className="text-sm">
                    <p className="font-medium text-blue-900 mb-1">ملاحظة مهمة</p>
                    <p className="text-blue-700">
                      سيتم التواصل معك عبر لوحة الاستشارة بعد التأكيد. يرجى متابعة الرسائل بانتظام.
                    </p>
                  </div>
                </div>
              </div>
