        ...
        <div className="flex items-center gap-4 mb-12">
          ...
          <div className="flex-1 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              خطط مرنة تناسب جميع الاحتياجات - من الموظفين الأفراد إلى المؤسسات
              الكبرى
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            <CardHeader className="text-center pb-8 pt-8">
              ...
              <CardTitle className="text-2xl mb-2">
                {pricingPlans.employee.name}
              </CardTitle>
              <CardDescription className="text-sm">
                {pricingPlans.employee.description}
              </CardDescription>
          ...
          >
            ...
            <CardHeader className="text-center pb-8 pt-8">
              ...
              <CardTitle className="text-2xl mb-2">
                {pricingPlans.freelancer.name}
              </CardTitle>
              <CardDescription className="text-sm">
                {pricingPlans.freelancer.description}
              </CardDescription>
          ...
          >
            ...
            <CardHeader className="text-center pb-6 pt-8">
              ...
              <CardTitle className="text-2xl mb-2">
                {pricingPlans.company.name}
              </CardTitle>
              <CardDescription className="text-sm">
                {pricingPlans.company.description}
              </CardDescription>
            </CardHeader>
          ...
          <CardContent>
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger className="text-right">
                  <span className="font-semibold">
                    هل يمكنني تجربة الباقة المدفوعة قبل الشراء؟
                  </span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  نعم! نوفر فترة تجريبية مجانية لمدة 14 يوم لجميع الباقات
                  المدفوعة. يمكنك تجربة جميع الميزات دون الحاجة لبطاقة ائتمان.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2">
                <AccordionTrigger className="text-right">
                  <span className="font-semibold">
                    هل يمكنني الترقية أو التخفيض بين الباقات؟
                  </span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  بالتأكيد! يمكنك الترقية أو التخفيض بين الباقات في أي وقت. عند
                  الترقية، ستدفع الفرق فقط للفترة المتبقية. عند التخفيض، سيتم
                  احتساب الرصيد المتبقي في الفترة القادمة.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-3">
                ...
                <AccordionContent className="text-muted-foreground">
                  نقبل جميع طرق الدفع الرئيسية: بطاقات الائتمان (Visa,
                  Mastercard, Mada)، Apple Pay، والتحويل البنكي للشركات. جميع
                  المعاملات آمنة ومشفرة.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent className="text-muted-foreground">
                  الأسعار المعروضة غير شاملة لضريبة القيمة المضافة (15%). سيتم
                  إضافة الضريبة عند الدفع وفقاً للأنظمة السعودية.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-5">
                <AccordionTrigger className="text-right">
                  <span className="font-semibold">
                    ماذا يحدث إذا تجاوزت عدد الموظفين المسموح؟
                  </span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  سنقوم بإشعارك تلقائياً عند الاقتراب من الحد الأقصى. يمكنك
                  الترقية للباقة الأعلى في أي وقت. لن يتم إيقاف الخدمة، لكن سيتم
                  احتساب رسوم إضافية بسيطة للموظفين الإضافيين.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-6">
                ...
                <AccordionContent className="text-muted-foreground">
                  نعم، يمكنك إلغاء الاشتراك في أي وقت دون أي رسوم إضافية. ستستمر
                  في الوصول للخدمة حتى نهاية الفترة المدفوعة. لن يتم تجديد
                  الاشتراك تلقائياً بعد الإلغاء.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-7">
                <AccordionTrigger className="text-right">
                  <span className="font-semibold">
                    هل تقدمون خصومات للدفع السنوي؟
                  </span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  نعم! نوفر خصم 20% عند الدفع السنوي مقدماً. على سبيل المثال،
                  باقة مستقل HR بـ 299 ريال شهرياً تصبح 2,870 ريال سنوياً (بدلاً
                  من 3,588 ريال).
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-8">
                <AccordionTrigger className="text-right">
                  <span className="font-semibold">
                    ما الفرق بين باقة مستقل HR وباقة الشركات؟
                  </span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  باقة مستقل HR مصممة للأفراد الذين يقدمون خدمات HR لعدة عملاء،
                  وتركز على الأدوات الفردية. باقة الشركات تشمل نظام إدارة كامل
                  مع ATS، إدارة الفريق، التذاكر، والتقارير المتقدمة - مناسبة
                  للشركات التي تدير موظفيها داخلياً.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-9">
                ...
                <AccordionContent className="text-muted-foreground">
                  نعم، نستخدم أعلى معايير الأمان (SSL 256-bit encryption) لحماية
                  بياناتك. جميع البيانات مخزنة في خوادم آمنة داخل السعودية
                  ومتوافقة مع قوانين حماية البيانات. نقوم بنسخ احتياطي يومي
                  لضمان عدم فقدان أي بيانات.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-10">
                <AccordionTrigger className="text-right">
                  <span className="font-semibold">
                    هل يمكنني طلب ميزات مخصصة؟
                  </span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  بالتأكيد! نوفر باقة Custom للمؤسسات الكبيرة التي تحتاج ميزات
                  مخصصة، تكامل خاص، أو تدريب مخصص. تواصل معنا لمناقشة احتياجاتك
                  وسنقوم بتصميم حل يناسبك.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </CardContent>
