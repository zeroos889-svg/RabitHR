...
const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: 'تم جدولة مقابلة مع أحمد محمد لوظيفة مطور واجهات أمامية - غداً الساعة 10 صباحاً',
    time: 'منذ ساعة',
    read: false,
  ...
  },
  {
    ...
    message: 'موعد التقييم السنوي للموظفين بعد 3 أيام. يرجى إكمال نماذج التقييم',
    time: 'منذ 3 ساعات',
    read: false,
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">
                  {notifications.filter(n => n.time.includes('دقائق') || n.time.includes('ساعة')).length}
                </p>
              </div>
