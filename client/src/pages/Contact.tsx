      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/contact">
              <a className="text-sm font-semibold text-primary">اتصل بنا</a>
            </Link>
          </nav>
          <Link href="/dashboard">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">
                          تعرف على الباقات والأسعار المناسبة لشركتك
                        </div>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">
                          احصل على مساعدة في استخدام المنصة
                        </div>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">
                          أي أسئلة أخرى نحن هنا للمساعدة
                        </div>
                      </div>
                    </li>
                  </ul>
              ...
              <Card className="bg-gradient-to-br from-blue-50 to-purple-50 border-0">
                <CardContent className="pt-6 space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    نحن ملتزمون بالرد على جميع الاستفسارات في أسرع وقت ممكن.
                    للحالات العاجلة، يُرجى الاتصال بنا هاتفياً.
                  </p>
                </CardContent>
              </Card>
